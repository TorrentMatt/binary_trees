...
/**
 * binary_tree_height_aux - finds the sibling of a node
 * @tree: the tree
...
/**
 * print_level_order -will finds the sibling of a node
...
/**
 * binary_tree_levelorder - finds the sibling of a node
 * @tree: the tree
 * @func: to func
 * Return: Return the height of the tree
 */
