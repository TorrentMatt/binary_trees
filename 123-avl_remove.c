...
/**
 * check_balance_avl -will check the balance of each node
...
/**
 * inorder_sucessor - will determine the next/previous node of the removed node
 * @tree: the node
...
/**
 * change_node - remove node by the next/previous node
 * @arg_tree: the removed node
 * @arg_node: the next/previous node
 * Return: no return
 */
...
/**
 * avl_search_remove -will search to remove a node in an AVL tree
 * @tree: tree root
 * @value: node value
...
/**
 * avl_remove - will removes a node in an AVL tree
 * @root: tree root
 * @value: node value
