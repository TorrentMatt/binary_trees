...
/**
 * recursive_depth -will  measures the depth of a node in a binary tree
 * @tree: tree root
...
/**
 * binary_tree_depth - calls recursive_depth to return the depth of node
 * @tree: tree root
...
/**
 * binary_tree_uncle - will finds the lowest common ancestor of two nodes
 * @first:  first node
 * @second: second node
