...
/**
 * count_heap_nodes - will count the number of nodes inside a tree
...
/**
 * bubble_down - will put a node value in a correct position in the heap
...
/**
 * get_parent -will find the parent node for a ceratin node
...
/**
 * remove_last_node -will remove the last node of a heap
...
/**
 * heap_extract - will extract the max value of a heap
